...
public class RelatoriosService {
	...
	public void inicial(Scanner scanner) {
		...
		while(system) {
			...
			System.out.println(" 4 - Busca Funcionario com dados resumidos");
	...
	private void buscaFuncionarioNome(Scanner scanner) {
		...
		List<Funcionario> list = repo.findByNome(nome);
	...
	private void buscaFuncionarioNomeSalarioMaiorData(Scanner scanner) {
		...
		System.out.println("Qual data contratao deseja pesquisar");
		...
		List<Funcionario> list = repo.findNomeSalarioMaiorDataContratacao(nome, salario, localDate);
		list.forEach(System.out::println);
	...
	private void buscaFuncionarioDataContratacao(Scanner scanner) {
		...
		List<Funcionario> funcionarios = repo.findDataContratacaoMaior(localDate);
		
		funcionarios.forEach(System.out::println);
	}
	
	private void pesquisaFuncionarioSalario() {
		List<FuncionarioProjecao> list = repo.findFuncionarioSalario();
